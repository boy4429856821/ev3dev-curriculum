...
def timed_driving():
    ...
    while time_s != 0:
        ...
        position = int(input("Enter a distance to travel (inches): "))
        position2 = 90*position
        left_motor.run_to_rel_pos(position_sp=position2, speed_sp=speed, stop_action="brake")
        right_motor.run_to_rel_pos(position_sp=position2, speed_sp=speed, stop_action="brake")
