...
# d: 2. Select one team member to open libs/mqtt_remote_method_calls.py and complete the TO DO that is in that file.
...
# d: 3. Run this program as is on your computer and watch the logs as you click in the window.
...
def main():
    ...
    # d: 5. Delete the line below (mqtt_client = None) then uncomment the code below.  It creates a real mqtt client.
...
def left_mouse_click(event, mqtt_client):
    ...
    # d: 6. Talk to your team members and have everyone pick a unique color.
    ...
    # MQTT draw
    # d: 7. Send a message using MQTT that will:
    ...
    # d: 8. Help get everyone on your team running this program at the same time.
