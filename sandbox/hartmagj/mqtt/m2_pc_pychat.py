...
def main():
    # d: 2. Set my_name and set team_member_name then try this program with that person.
    # For teams of 3 just have 2 people talk to each other and the other person can just watch this time.
    my_name = "the third reich"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Big Daddy Swags"   # Used to set the topic that you will *publish to*
