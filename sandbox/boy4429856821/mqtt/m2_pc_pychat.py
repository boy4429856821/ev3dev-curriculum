...
def main():
    ...
    my_name = "Big Daddy Swags"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "the third reich"  # Used to set the topic that you will *publish to*
